        ...
        <Col md={3}>
          <Card className="bg-primary text-white">
            <Card.Body>
              ...
              <p><small>↑ 12% from last month</small></p>
            </Card.Body>
          </Card>
        </Col>
        <Col md={3}>
          <Card className="bg-success text-white">
            <Card.Body>
              ...
              <p><small>↑ 5% from last month</small></p>
            </Card.Body>
          </Card>
        </Col>
        <Col md={3}>
          <Card className="bg-info text-white">
            <Card.Body>
              ...
              <p><small>↑ 8% from last month</small></p>
            </Card.Body>
          </Card>
        </Col>
        <Col md={3}>
          <Card className="bg-warning text-white">
            <Card.Body>
              ...
              <p><small>↑ 15% from last month</small></p>
            </Card.Body>
          </Card>
        </Col>
      </Row>
                ...
                <tbody>
                  {recentActivities.map((activity) => (
                    <tr key={activity.id}>
                      ...
                      <td>{activity.user}</td>
                      <td>
                        <Badge bg={getActivityBadgeColor(activity.activity)}>
                          {activity.activity}
                        </Badge>
                      </td>
      ...
      <Row className="mt-4">
          <Col>
            <div className="text-center text-muted py-3 border-top">
              <small>© {new Date().getFullYear()} Blog App. All Rights Reserved.</small>
            </div>
          </Col>
        </Row>
    </Container>
